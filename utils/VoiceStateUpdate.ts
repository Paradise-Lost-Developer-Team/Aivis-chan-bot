                                    ...
                                    try {
                                        ...
                                        if (preferred) {
                                            ...
                                            try {
                                                ...
                                                console.log(`[BotJoin:5th] guild=${guild.id} 登録されたテキスト候補数=1 selected=${(preferred && preferred.id) || preferred}`);
                                            } catch (e) {
                                                console.error('[BotJoin:5th] addTextChannelsForGuildInMap エラー:', e);
                                            }
                                        }
                                    } catch (e) {
