...
import { voiceClients, loadAutoJoinChannels, MAX_TEXT_LENGTH, speakVoice, speakAnnounce, updateLastSpeechTime, monitorMemoryUsage, textChannels, normalizeTextChannelsMap, getTextChannelFromMapByGuild } from './TTS-Engine';
