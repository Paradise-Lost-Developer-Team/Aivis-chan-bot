...
// 単語を編集する処理
async function editWordInDictionary(guildId, word, pronunciation, accentType, wordType) {
    try {
        // 辞書ファイルを読み込む
...
module.exports = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('new_pronunciation')
...
//# sourceMappingURL=edit_word.js.map